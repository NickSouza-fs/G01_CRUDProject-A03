 ...
 * @author 826184804
 */
public class Form_Alterar extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel5.setText("Alteraração de usuário");
    ...
    private void btnAlterarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAlterarActionPerformed
        ...
        String usuario = "root";
        String senha = "123";
        String alterQuery = "UPDATE tbl_usuarios SET senhaUsuario = \"" +senhaU+ "\"";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Form_Alterar.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
