 ...
 * @author 826184804
 */
public class Form_Incluir extends javax.swing.JFrame {
    ...
    private void btnIncluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnIncluirActionPerformed
        ...
        String senhaUsuario = jTextField3.getText();
        int idadeUsuario = Integer.parseInt(jTextField4.getText());
        ...
        String incluir = "INSERT INTO tbl_usuarios (loginUsuario, senhaUsuario, nomeUsuario, idadeUsuario) VALUES (\'" +loginUsuario+ "\', \'" +senhaUsuario+ "\', " +idadeUsuario+ ")";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Form_Incluir.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Form_Incluir().setVisible(true);
            }
        });
    }
