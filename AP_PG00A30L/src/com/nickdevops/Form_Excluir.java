 ...
 * @author 826184804
 */
public class Form_Excluir extends javax.swing.JFrame {

    /**
     * Creates new form Form_Alterar
     */
    public Form_Excluir() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel5.setText("Exclusão de usuário");
    ...
    private void btnConsultarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnConsultarActionPerformed
        ...
        String usuario = "root";
        String senha = "123";
        String searchQuery = "SELECT * FROM tbl_usuarios WHERE loginUsuario = \"" +idUsuario+ "\"";
    ...
    private void btnExcluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnExcluirActionPerformed
        ...
        String idUsuario = jTextField1.getText();
        String nomeU = jTextField2.getText();
        String senhaU = jTextField3.getText();
        int idadeU = Integer.parseInt(jTextField4.getText());
        
        Connection con = null;
        String url = "jdbc:mysql://127.0.0.1:3306/base_universitaria";
        String usuario = "root";
        String senha = "123";
        String alterQuery = "DELETE FROM tbl_usuarios WHERE idUsuario = \"" +idUsuario+ "\"";
        ...
        try {
            ...
            int Linhas = stmt.executeUpdate(alterQuery);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Form_Excluir.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Form_Excluir().setVisible(true);
            }
        });
    }
